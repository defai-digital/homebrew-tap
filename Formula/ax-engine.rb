class AxEngine < Formula
  ...
  url "https://github.com/defai-digital/ax-engine/releases/download/v7.2.1/ax-engine-v7.2.1-macos-arm64.tar.gz"
  version "7.2.1"
  sha256 "12cc9d6338c494f6a3a0182f352749df6dd0b3a0200730ee508475fe86f9e4d6"
  license "Apache-2.0"
