class AxEngine < Formula
  ...
  url "https://github.com/defai-digital/ax-engine/releases/download/v7.2.0/ax-engine-v7.2.0-macos-arm64.tar.gz"
  version "7.2.0"
  sha256 "d5e3ce59163c28ecaf391d2b751f4bfbad22bb3e31d26192bfed0a5a8d21dd19"
  license "Apache-2.0"
