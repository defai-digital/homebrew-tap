class AxEngine < Formula
  ...
  url "https://github.com/defai-digital/ax-engine/releases/download/v7.5.2/ax-engine-v7.5.2-macos-arm64.tar.gz"
  version "7.5.2"
  sha256 "28eeec5768dc018c923f1162356da2bbbfcd84640a9aa398b2f05893776d6b94"
  license "Apache-2.0"
