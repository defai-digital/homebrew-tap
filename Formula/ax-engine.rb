class AxEngine < Formula
  ...
  url "https://github.com/defai-digital/ax-engine/releases/download/v7.5.5/ax-engine-v7.5.5-macos-arm64.tar.gz"
  version "7.5.5"
  sha256 "f83b82d0de865c2ff92e05794db0265e6b9804b03300d758adea89d641d1879a"
  license "Apache-2.0"
