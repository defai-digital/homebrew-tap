class AxEngine < Formula
  ...
  url "https://github.com/defai-digital/ax-engine/releases/download/v7.1.3/ax-engine-v7.1.3-macos-arm64.tar.gz"
  version "7.1.3"
  sha256 "e0e7fc5a51752f51ab37a47f327261394c1aeae96d6afcd3c5cf0e032af8b7a9"
  license "Apache-2.0"
