class AxEngine < Formula
  ...
  url "https://github.com/defai-digital/ax-engine/releases/download/v7.3.1/ax-engine-v7.3.1-macos-arm64.tar.gz"
  version "7.3.1"
  sha256 "e421960456469f568756aa745cbebaa7924a51cc30221254c5360ec035b3e1e9"
  license "Apache-2.0"
