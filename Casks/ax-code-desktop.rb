cask "ax-code-desktop" do
  version "7.4.0"
  sha256 "d8663a113a408c2f268b6e2a77361744a73684df1d64567f24372bc7e245969a"

  url "https://github.com/defai-digital/ax-code/releases/download/desktop-v7.4.0/AX-Code-#{version}-mac-arm64.dmg"
